...
bool matchadd_weight_input_pick_source(Morphism *morphism)
{
...
void applyadd_weight_input_pick_source(Morphism *morphism, bool record_changes)
{
...
bool fillpotadd_weight_input_pick_source(MorphismPot *pot, Morphism *morphism)
{
   if(1 > add_weight_input_host->number_of_nodes || 0 > add_weight_input_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < add_weight_input_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "add_weight_input_pick_source", add_weight_input_host);
